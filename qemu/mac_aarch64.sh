...
BOOT_DIR="-L /opt/homebrew/Cellar/qemu/9.1.0/share/qemu" # /Applications/UTM.app/Contents/Resources/qemu 
...
FRAMEWARE="-drive if=pflash,format=raw,unit=0,file.filename=/opt/homebrew/Cellar/qemu/9.1.0/share/qemu/edk2-aarch64-code.fd,file.locking=off,readonly=on"
# FRAMEWARE_VAR
FRAMEWARE_VAR="-drive if=pflash,format=raw,unit=1,file=/opt/homebrew/Cellar/qemu/9.1.0/share/qemu/edk2-arm-vars.fd"
...
DISK="-device virtio-blk-pci,drive=drive2BC0901F-DA56-49C7-A0D2-98F71114CB44,bootindex=1 -drive if=none,media=disk,id=drive2BC0901F-DA56-49C7-A0D2-98F71114CB44,file=$HOME/Downloads/debian-12-nocloud-arm64.qcow2,discard=unmap,detect-zeroes=unmap"
